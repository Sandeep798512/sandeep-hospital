...
const Navbar = ({ toggleSidebar, sidebarCollapsed }) => {
  ...
  return (
    <header className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 h-16 fixed top-0 right-0 z-20 flex items-center justify-between px-6 transition-all duration-300 shadow-md shadow-slate-200/20 dark:shadow-slate-950/50" 
      ...
      <div className="flex items-center space-x-4">
        <button
          ...
          className="p-2 rounded-xl text-slate-500 hover:text-slate-800 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer"
        >
      ...
      {/* Right side: theme toggle, notices & user profile dropdown */}
      <div className="flex items-center space-x-3">
        ...
        <button 
          type="button"
          className="relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer"
        >
